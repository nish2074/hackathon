...
const dayMessages = {
  0: "Pestisides to be add  Fungicide: Mancozeb + Liquid Copper – 3 lb per acre. Insecticide: Admire (Alias) – see label for rate, or Verimark – 6.75 to 13.5 fl oz per acre.",
...
const Register = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://tourdefarm.in/wp-content/uploads/2021/01/IMG_0327-001.jpg')"
      }}
    >
      <div className="bg-white/60 shadow-xl mt-24 mb-20 rounded-4xl p-4 max-w-2xl w-full backdrop-blur-md">
        <h1 className="text-3xl font-bold text-green-700 text-center mb-8">Grapes Spray Schedule 🌱</h1>
